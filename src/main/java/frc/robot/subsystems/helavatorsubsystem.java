...
public class helavatorsubsystem extends SubsystemBase {
    ...
    static DigitalInput extendedhelavatorlimitswitch = new DigitalInput(2);
    static DigitalInput retractedhelavatorlimitswitch = new DigitalInput(3);
  ...
  public static boolean retractedflipperlimitswitchstatus() {
    ...
    public static boolean extendedhelavatorlimitswitchstatus() {
        return extendedhelavatorlimitswitch.get();
