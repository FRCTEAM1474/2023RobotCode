...
public class Drivetrain extends SubsystemBase {
  ...
  public double getLeftMotorSpeed() {
    double leftmotorspeed = leftLead.getSelectedSensorVelocity() * Constants.OperatorConstants.metersPerEncoderTick;
    return leftmotorspeed;
  }

  public double getRightMotorSpeed() {
    double rightmotorspeed = rightLead.getSelectedSensorVelocity() * Constants.OperatorConstants.metersPerEncoderTick;
